...
(
    genre_id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
(
    director_id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    film_id     BIGINT REFERENCES film (film_id),
...
(
    event_type_id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    name          VARCHAR(50) NOT NULL
);